...
public class ImagePublishAdapter extends BaseAdapter
{
	...
	public int getCount()
	{
		...
		else if (mDataList.size() == GlobalWiwikey.MAX_IMAGE_SIZE)
		{
			return GlobalWiwikey.MAX_IMAGE_SIZE;
		}
		else
		{
	...
	{
		if (mDataList != null
				&& mDataList.size() == GlobalWiwikey.MAX_IMAGE_SIZE)
		{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (isShowAddItem(position))
		{
			...
			imageIv.setBackgroundResource(R.color.colorWhite);
		}
		else
		{
