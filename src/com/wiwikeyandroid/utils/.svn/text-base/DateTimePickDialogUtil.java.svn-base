...
public class DateTimePickDialogUtil implements OnDateChangedListener,  
     ...
     * @return 
     */  
    public AlertDialog dateTimePicKDialog(final TextView tvDateTime) {  
    ...
    private Calendar getCalendarByInintData(String initDateTime) {  
        ...
        String yearStr = temp[0]; // 年份  
        String monthStr = temp[1]; // 月
        String dayStr = temp[2]; // 日  
  
        String temp1[] = date.toString().split(":");
        String hourStr = temp1[0]; // 时  
        String minuteStr = temp1[1]; // 分  
