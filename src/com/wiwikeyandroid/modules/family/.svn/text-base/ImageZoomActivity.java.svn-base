...
import com.wiwikeyandroid.modules.family.RepairsCommitActivity;
import com.wiwikeyandroid.utils.ImageDisplayer;
...
public class ImageZoomActivity extends Activity {
	...
	private void initData() {
		...
		mDataList =getIntent().getStringExtra(IntentConstants.EXTRA_IMAGE_LIST).isEmpty()?RepairsCommitActivity.mDataList:ComplainCommitActivity.mDataList;
	}
